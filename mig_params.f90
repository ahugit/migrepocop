...
logical, parameter :: groups=.true.,onlysingles=.true.,onlymales=.false.,onlyfem=.false.,optimize=.false.,chkstep=.false.,condmomcompare=.false.,comparepars=.false.,extramoments=.true. !ahu030622
logical :: nonneg
    logical, parameter :: onthejobsearch=.TRUE. !set in m\ain
	integer(i4b), parameter :: numit=10 !ahumarch1122
